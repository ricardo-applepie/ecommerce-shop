    ...
    <div className="navbar__inner-wrapper content__wrapper-width mobile-container">
        ...
        <div id ="right" className="navbar__right-wrapper">
            ...
            <div className="shopping-items">
               ...
               {
                        props.total && props.total.subtotal && props.total.line_items.map(function(productItem){
                            return(
                                <div>
                ...
                <div className="total_sum-in-cart">
                    ...
                    <span className="total-amount">{props.total && props.total.subtotal && props.total.subtotal.formatted_with_code}</span>
